...
(function($) {
	...
	var methods = {
		...
		display : function() {
			...
			if (!maxWidth || maxWidth > screenWidth * maxScreen / 300) {
				maxWidth = screenWidth * maxScreen / 300;
			}
			if (!maxHeight || maxHeight > screenHeight * maxScreen / 300) {
				maxHeight = screenHeight * maxScreen / 300;
			}
