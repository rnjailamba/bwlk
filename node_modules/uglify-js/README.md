...
For example:
    ...
    uglifyjs /home/doe/work/foo/src/jsNew/file1.js \
             /home/doe/work/foo/src/jsNew/file2.js \
             -o foo.min.js \
...
mapping will refer to `http://foo.com/src/jsNew/file1.js` and
`http://foo.com/src/jsNew/file2.js` (in fact it will list `http://foo.com/src`
